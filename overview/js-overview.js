...
// Sort presets. currentSortField accepts: number, introduced, modified, type, status, or null.
// isAscending = true sorts low-to-high / oldest-first; false sorts high-to-low / newest-first.
// "number" uses only the bill-number suffix after the hyphen.
// let currentSortField = 'number';    let isAscending = false; // Latest bill number (default)
// let currentSortField = 'number';    let isAscending = true;  // Earliest bill number first
// let currentSortField = 'introduced'; let isAscending = false; // Latest introduction first
// let currentSortField = 'modified';   let isAscending = false; // Latest modification first
// let currentSortField = 'type';       let isAscending = true;  // Type A-Z
// let currentSortField = 'status';     let isAscending = true;  // Status A-Z
// let currentSortField = null;         let isAscending = true;  // Preserve data order
